...
create_clock -period 10.000 -name sys_clk_pin -waveform {0.000 5.000} -add [get_ports iclk]; # 100 MHz Arty clock
...
## Pmod Header JA
set_property -dict {PACKAGE_PIN G13 IOSTANDARD LVCMOS33} [get_ports dio]; # data input-out
set_property -dict {PACKAGE_PIN B11 IOSTANDARD LVCMOS33} [get_ports oclk]; # 1 MHz output clock
...
set_property -dict {PACKAGE_PIN A9 IOSTANDARD LVCMOS33} [get_ports uart_rx_data]; # UART input port
